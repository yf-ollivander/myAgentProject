...
CREATE TABLE IF NOT EXISTS `ai_feishu_bot` (
  ...
  UNIQUE KEY `uk_ai_feishu_bot_app_id` (`app_id`),
...
CREATE TABLE IF NOT EXISTS `ai_feishu_user_binding` (
  `id` varchar(36) NOT NULL, `create_by` varchar(50) DEFAULT NULL, `create_time` datetime(3) NOT NULL,
  ...
  `del_flag` tinyint(1) NOT NULL DEFAULT 0, `bot_id` varchar(36) NOT NULL,
  `sender_open_id` varchar(128) NOT NULL, `user_id` varchar(36) NOT NULL, `username` varchar(50) NOT NULL,
  `binding_source` varchar(16) NOT NULL, `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `last_used_at` datetime(3) DEFAULT NULL, PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ai_feishu_binding_token` (
  `id` varchar(36) NOT NULL, `tenant_id` varchar(32) NOT NULL, `bot_id` varchar(36) NOT NULL,
  `user_id` varchar(36) NOT NULL, `username` varchar(50) NOT NULL, `token_hash` char(64) NOT NULL,
  `status` varchar(16) NOT NULL, `expires_at` datetime(3) NOT NULL,
  `used_by_open_id` varchar(128) DEFAULT NULL, `used_at` datetime(3) DEFAULT NULL, `create_time` datetime(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai_feishu_inbound_event` (
  `id` varchar(36) NOT NULL, `tenant_id` varchar(32) NOT NULL, `event_key` varchar(200) NOT NULL,
  `bot_id` varchar(36) NOT NULL, `event_type` varchar(16) NOT NULL, `message_id` varchar(128) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ai_feishu_session` (
  `id` varchar(36) NOT NULL, `tenant_id` varchar(32) NOT NULL, `bot_id` varchar(36) NOT NULL,
  `chat_id` varchar(128) NOT NULL, `thread_key` varchar(128) NOT NULL, `root_message_id` varchar(128) NOT NULL,
  `run_id` varchar(36) NOT NULL, `binding_id` varchar(36) NOT NULL, `sender_open_id` varchar(128) NOT NULL,
  `status` varchar(16) NOT NULL, `last_message_id` varchar(128) DEFAULT NULL,
  `create_time` datetime(3) NOT NULL, `update_time` datetime(3) DEFAULT NULL,
  `active_session_key` varchar(400) GENERATED ALWAYS AS
    (CASE WHEN `status` IN ('ACTIVE','WAITING') THEN CONCAT(`bot_id`,':',`chat_id`,':',`thread_key`) ELSE NULL END) STORED,
...
CREATE TABLE IF NOT EXISTS `ai_feishu_delivery` (
  `id` varchar(36) NOT NULL, `tenant_id` varchar(32) NOT NULL, `event_id` varchar(64) NOT NULL,
  `run_id` varchar(36) DEFAULT NULL, `event_type` varchar(48) NOT NULL, `event_sequence` bigint DEFAULT NULL,
  ...
  `message_type` varchar(16) NOT NULL, `content_cipher` longtext NOT NULL, `content_hash` char(64) NOT NULL,
  `status` varchar(16) NOT NULL, `claim_token` varchar(64) DEFAULT NULL, `claimed_until` datetime(3) DEFAULT NULL,
  `retry_count` int NOT NULL DEFAULT 0, `next_retry_at` datetime(3) NOT NULL,
